...
module.exports = function (env, argv) {
  ...
  return {
    ...
    output: {
      ...
      publicPath: argv.mode === 'production' || env.asBuild ? '/' + (env && env.subDomain || '') + 'wp-content/themes/task/assets/' : './',
    },
          ...
          use: [{
            ...
            options: {
              publicPath: function (url) {
                return argv.mode === 'production' || env.asBuild ? '/' + (env && env.subDomain || '') + 'wp-content/themes/task/assets/' + url : './' + url;
              },
              name: '[path][name].[ext]',
