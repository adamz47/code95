export function headerSticky(container = document) {
  ...
  const headerTopPart = document.querySelector('header.webofai_theme_header .menu-top-menu-container').clientHeight;
  const headerHeight = document.querySelector('header.webofai_theme_header').clientHeight;
